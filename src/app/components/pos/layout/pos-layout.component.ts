...
export class PosLayoutComponent implements OnInit {
  ...
  constructor(private sanitizer: DomSanitizer, private router: Router, private auth: AuthService, public theme: ThemeService) {
    this.menuItems = ([
      { id: 'terminal',  label: 'Terminal',   svg: '<rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/>' },
      { id: 'historial', label: 'Historial',  svg: '<path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="12" y2="17"/>' },
